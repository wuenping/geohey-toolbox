...
class OffsetWGS84Algorithm(GeoAlgorithm):
    ...
    def defineCharacteristics(self):
        ...
        self.name = 'Offset WGS84 to GCJ02'
    ...
    def processAlgorithm(self, progress):
        ...
        # Do the transform
        QgsMessageLog.logMessage("Start processing ...", 'OffsetWGS84Algorithm', QgsMessageLog.INFO)
        ...
        for f in features:
            ...
            if geom_type == QGis.WKBPoint:
                ...
                new_vert = engine.wgs84ToGcj02(vertices)
        ...
        QgsMessageLog.logMessage("Successful finished.", 'OffsetWGS84Algorithm', QgsMessageLog.INFO)