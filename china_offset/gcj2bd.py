...
from .transform import gcj2bd
import os


class GCJ2BD(GeoAlgorithm):
    ...
    def processAlgorithm(self, progress):
        ...
        for f in features:
            ...
            if geom_type == QGis.WKBPoint:
                ...
                new_vert = gcj2bd(vertices[0], vertices[1])
        ...
        QgsMessageLog.logMessage("Successful finished.", 'GCJ2BD', QgsMessageLog.INFO)