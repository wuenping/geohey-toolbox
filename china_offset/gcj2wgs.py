    ...
    def processAlgorithm(self, progress):
        ...
        for f in features:
            ...
            if geom_type == QGis.WKBPoint:
                ...
                new_vert = gcj2wgs(vertices[0], vertices[1])
        ...
        QgsMessageLog.logMessage("Successful finished.", 'GCJ2WGS', QgsMessageLog.INFO)