    ...
    def processAlgorithm(self, progress):
        ...
        for f in features:
            ...
            if geom_type == QGis.WKBPoint:
                ...
                new_vert = wgs2gcj(vertices[0], vertices[1])
        ...
        QgsMessageLog.logMessage("Successful finished.", 'WGS2GCJ', QgsMessageLog.INFO)